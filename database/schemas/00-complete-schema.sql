-- ==============================================================================
-- AI Agent Mastery - TypeScript Edition - Complete Database Schema
-- ==============================================================================
-- Adapted from the Python version for TypeScript implementation
...
-- NOTE: Change vector dimension based on your embedding model:
...
CREATE TABLE documents (
  ...
  embedding vector(1536) -- Update dimension if using different embedding model
);
...
-- NOTE: Update vector dimension to match documents table and your embedding model
CREATE OR REPLACE FUNCTION match_documents (
  query_embedding vector(1536), -- Update dimension if using different embedding model
...
-- NOTE: This is a powerful function - use with caution
-- Only backend with service role key should call this
...
-- Document tables are locked down - only backend can access
...
-- Next steps:
-- 1. Update vector dimensions if using different embedding model (see comments above)
-- 2. Configure your application environment variables
-- 3. Run your AI agent and RAG pipeline
-- 4. Test the TypeScript application

-- Embedding Model Dimensions Reference:
-- - OpenAI text-embedding-3-small: 1536 (default in this schema)
-- - OpenAI text-embedding-3-large: 3072
-- - Ollama nomic-embed-text: 768
